...
- I added the command `npm run test` to run e2e tests for the application, be aware that this command drops the database and rebuilds it.
- Implemented E2E testing

Things I would have implemented if I had more time:

- I would have added documentation using OpenAPI (Swagger); that way, it can also be easier to test or even generate client SDKs
